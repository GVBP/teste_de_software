...
describe('Função que recebe um vetor, e retorna quantas vogal foram encontradas em ordem', function() {
  function consoantes(arr) {
    ...
    return vogais.sort(); // IMPLEMENTE
  }

  it('retorna o array de vogal teste um', function() {
  ...
  it('retorna o array de vogal teste três', function() {
    expect(consoantes(['a', 'e', 'i', 'x', 'o', 'u'])).toEqual(['a', 'e', 'i', 'o', 'u']);
  });

  it('retorna o array de vogal teste quatro', function() {
